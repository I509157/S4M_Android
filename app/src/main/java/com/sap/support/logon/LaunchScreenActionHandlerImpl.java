...
import static com.sap.support.logon.ActivationActionHandlerImpl.DISCOVERY_SVC_EMAIL;
...
public class LaunchScreenActionHandlerImpl extends WelcomeScreenActionHandlerImpl implements ActivityResultActionHandler {
    ...
    private static final String ACTIVATION_EMAIL = "user@int-dgq5qdz5dm.pilot.sapmobileplace.com";
    ...
    private boolean authenticateWithServer(Fragment fragment) {
        ...
        try {
            ...
            if (token != null) {
                ...
                activity.finish();
                // Initialize logging and update logs
    ...
    private void promptForProviderInput(Activity activity) {
        ...
        activationSettings.setActionHandler("com.sap.support.logon.ActivationActionHandlerImpl");
        activationSettings.setActivationTitle(activity.getString(R.string.application_name));
        activationSettings.setActivationEmailHint(ACTIVATION_EMAIL);
        activationSettings.setActivationDiscoveryService(ACTIVATION_EMAIL);
