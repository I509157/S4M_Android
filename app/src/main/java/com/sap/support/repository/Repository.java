...
import com.sap.support.archcomp.SingleLiveEvent;
import com.sap.support.mediaresource.EntityMediaResource;

import com.sap.support.repository.OperationResult.Operation;
...
public class Repository<T extends EntityValue> {
     ...
     * OData service
     */
    private AM_INCIDENT_SRV_Entities aM_INCIDENT_SRV_Entities;
     ...
     * @param aM_INCIDENT_SRV_Entities - OData service
     * @param entitySet - the entity set this repository provides access for
     */
    public Repository(@NonNull AM_INCIDENT_SRV_Entities aM_INCIDENT_SRV_Entities, @NonNull EntitySet entitySet, @Nullable Property orderByProperty) {
        this.aM_INCIDENT_SRV_Entities = aM_INCIDENT_SRV_Entities;
        this.entitySet = entitySet;
        this.orderByProperty = orderByProperty;
        observableEntities = new MutableLiveData<>();
        if (EntityMediaResource.isV4(aM_INCIDENT_SRV_Entities.getMetadata().getVersionCode()) && EntityMediaResource.hasMediaResources(entitySet)) {
    ...
    public void read() {
        ...
        aM_INCIDENT_SRV_Entities.executeQueryAsync(dataQuery,
            result -> {
    ...
    public void read(EntityValue parent, String navigationPropertyName) {
        ...
        aM_INCIDENT_SRV_Entities.loadPropertyAsync(navigationProperty, parent, dataQuery,
            () -> {
    ...
    public void create(@NonNull T newEntity, @NonNull StreamBase media) {
        if (newEntity.getEntityType().isMedia()) {
            aM_INCIDENT_SRV_Entities.createMediaAsync(newEntity, media,
                () -> {
    ...
    public void create(@NonNull T newEntity) {
        ...
        aM_INCIDENT_SRV_Entities.createEntityAsync(newEntity,
            () -> {
                insertToCache(newEntity, entities);
                if (relatedEntities.size() > 0) {
                    insertToCache(newEntity, relatedEntities);
    ...
    public void update(@NonNull T updateEntity) {
        aM_INCIDENT_SRV_Entities.updateEntityAsync(updateEntity,
            () -> {
    ...
    public void delete(@NonNull List<T> deleteEntities) {
        ...
        aM_INCIDENT_SRV_Entities.applyChangesAsync(deleteChangeSet,
            () -> {
    ...
    public void downloadMedia(@NonNull T entity, Action1<byte[]> successHandler,
        ...
        aM_INCIDENT_SRV_Entities.downloadMediaAsync(entity,
