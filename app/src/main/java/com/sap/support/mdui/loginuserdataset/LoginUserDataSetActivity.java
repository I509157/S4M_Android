 ...
 * - {@link LoginUserDataSetCreateFragment}: to create or edit a(n) LoginUserData,
 * - {@link LoginUserDataSetDetailFragment}: to display the details of a(n) LoginUserData,
 * - {@link LoginUserDataSetListFragment}: to list LoginUserDataSet.
 *
 ...
 * what to do.
 */
public class LoginUserDataSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LoginUserData> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LoginUserDataSetListFragment} is
     * getting instantiated (which will load {@link LoginUserDataSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LoginUserDataSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LoginUserData entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LoginUserDataSetCreateFragment fragment = new LoginUserDataSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LoginUserData entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LoginUserDataSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LoginUserDataSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LoginUserData entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LoginUserDataSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LoginUserDataSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LoginUserDataViewModel viewModel = ViewModelProviders.of(getActivity()).get(LoginUserDataViewModel.class);
