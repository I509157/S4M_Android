 ...
 * - {@link AttachmentSetCreateFragment}: to create or edit a(n) Attachment,
 * - {@link AttachmentSetDetailFragment}: to display the details of a(n) Attachment,
 * - {@link AttachmentSetListFragment}: to list AttachmentSet.
 *
 ...
 * what to do.
 */
public class AttachmentSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Attachment> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link AttachmentSetListFragment} is
     * getting instantiated (which will load {@link AttachmentSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new AttachmentSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Attachment entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        AttachmentSetCreateFragment fragment = new AttachmentSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Attachment entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new AttachmentSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new AttachmentSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Attachment entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link AttachmentSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((AttachmentSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            AttachmentViewModel viewModel = ViewModelProviders.of(getActivity()).get(AttachmentViewModel.class);
