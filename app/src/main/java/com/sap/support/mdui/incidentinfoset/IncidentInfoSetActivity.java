 ...
 * - {@link IncidentInfoSetCreateFragment}: to create or edit a(n) IncidentInfo,
 * - {@link IncidentInfoSetDetailFragment}: to display the details of a(n) IncidentInfo,
 * - {@link IncidentInfoSetListFragment}: to list IncidentInfoSet.
 *
 ...
 * what to do.
 */
public class IncidentInfoSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<IncidentInfo> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link IncidentInfoSetListFragment} is
     * getting instantiated (which will load {@link IncidentInfoSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new IncidentInfoSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable IncidentInfo entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        IncidentInfoSetCreateFragment fragment = new IncidentInfoSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable IncidentInfo entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new IncidentInfoSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new IncidentInfoSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable IncidentInfo entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link IncidentInfoSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((IncidentInfoSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            IncidentInfoViewModel viewModel = ViewModelProviders.of(getActivity()).get(IncidentInfoViewModel.class);
