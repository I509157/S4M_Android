 ...
 * - {@link ExpertAreaSetCreateFragment}: to create or edit a(n) ExpertArea,
 * - {@link ExpertAreaSetDetailFragment}: to display the details of a(n) ExpertArea,
 * - {@link ExpertAreaSetListFragment}: to list ExpertAreaSet.
 *
 ...
 * what to do.
 */
public class ExpertAreaSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ExpertArea> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ExpertAreaSetListFragment} is
     * getting instantiated (which will load {@link ExpertAreaSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ExpertAreaSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ExpertArea entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ExpertAreaSetCreateFragment fragment = new ExpertAreaSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ExpertArea entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ExpertAreaSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ExpertAreaSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ExpertArea entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ExpertAreaSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ExpertAreaSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ExpertAreaViewModel viewModel = ViewModelProviders.of(getActivity()).get(ExpertAreaViewModel.class);
