 ...
 * - {@link SystemSearchSetCreateFragment}: to create or edit a(n) SystemSearch,
 * - {@link SystemSearchSetDetailFragment}: to display the details of a(n) SystemSearch,
 * - {@link SystemSearchSetListFragment}: to list SystemSearchSet.
 *
 ...
 * what to do.
 */
public class SystemSearchSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<SystemSearch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link SystemSearchSetListFragment} is
     * getting instantiated (which will load {@link SystemSearchSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new SystemSearchSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable SystemSearch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        SystemSearchSetCreateFragment fragment = new SystemSearchSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable SystemSearch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new SystemSearchSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new SystemSearchSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable SystemSearch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link SystemSearchSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((SystemSearchSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            SystemSearchViewModel viewModel = ViewModelProviders.of(getActivity()).get(SystemSearchViewModel.class);
