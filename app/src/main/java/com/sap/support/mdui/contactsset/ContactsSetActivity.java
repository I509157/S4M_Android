 ...
 * - {@link ContactsSetCreateFragment}: to create or edit a(n) Contacts,
 * - {@link ContactsSetDetailFragment}: to display the details of a(n) Contacts,
 * - {@link ContactsSetListFragment}: to list ContactsSet.
 *
 ...
 * what to do.
 */
public class ContactsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Contacts> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ContactsSetListFragment} is
     * getting instantiated (which will load {@link ContactsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ContactsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Contacts entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ContactsSetCreateFragment fragment = new ContactsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Contacts entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ContactsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ContactsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Contacts entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ContactsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ContactsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ContactsViewModel viewModel = ViewModelProviders.of(getActivity()).get(ContactsViewModel.class);
