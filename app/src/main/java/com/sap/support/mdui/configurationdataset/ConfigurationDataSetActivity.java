 ...
 * - {@link ConfigurationDataSetCreateFragment}: to create or edit a(n) ConfigurationData,
 * - {@link ConfigurationDataSetDetailFragment}: to display the details of a(n) ConfigurationData,
 * - {@link ConfigurationDataSetListFragment}: to list ConfigurationDataSet.
 *
 ...
 * what to do.
 */
public class ConfigurationDataSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ConfigurationData> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ConfigurationDataSetListFragment} is
     * getting instantiated (which will load {@link ConfigurationDataSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfigurationDataSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ConfigurationData entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ConfigurationDataSetCreateFragment fragment = new ConfigurationDataSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ConfigurationData entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfigurationDataSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ConfigurationDataSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ConfigurationData entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ConfigurationDataSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ConfigurationDataSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ConfigurationDataViewModel viewModel = ViewModelProviders.of(getActivity()).get(ConfigurationDataViewModel.class);
