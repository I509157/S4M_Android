 ...
 * - {@link MessageCoreSetCreateFragment}: to create or edit a(n) MessageCore,
 * - {@link MessageCoreSetDetailFragment}: to display the details of a(n) MessageCore,
 * - {@link MessageCoreSetListFragment}: to list MessageCoreSet.
 *
 ...
 * what to do.
 */
public class MessageCoreSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MessageCore> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MessageCoreSetListFragment} is
     * getting instantiated (which will load {@link MessageCoreSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MessageCoreSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MessageCore entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MessageCoreSetCreateFragment fragment = new MessageCoreSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MessageCore entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MessageCoreSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MessageCoreSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MessageCore entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MessageCoreSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MessageCoreSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MessageCoreViewModel viewModel = ViewModelProviders.of(getActivity()).get(MessageCoreViewModel.class);
