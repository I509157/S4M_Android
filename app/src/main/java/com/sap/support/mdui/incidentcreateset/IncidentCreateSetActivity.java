 ...
 * - {@link IncidentCreateSetCreateFragment}: to create or edit a(n) IncidentCreate,
 * - {@link IncidentCreateSetDetailFragment}: to display the details of a(n) IncidentCreate,
 * - {@link IncidentCreateSetListFragment}: to list IncidentCreateSet.
 *
 ...
 * what to do.
 */
public class IncidentCreateSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<IncidentCreate> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link IncidentCreateSetListFragment} is
     * getting instantiated (which will load {@link IncidentCreateSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new IncidentCreateSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable IncidentCreate entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        IncidentCreateSetCreateFragment fragment = new IncidentCreateSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable IncidentCreate entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new IncidentCreateSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new IncidentCreateSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable IncidentCreate entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link IncidentCreateSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((IncidentCreateSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            IncidentCreateViewModel viewModel = ViewModelProviders.of(getActivity()).get(IncidentCreateViewModel.class);
