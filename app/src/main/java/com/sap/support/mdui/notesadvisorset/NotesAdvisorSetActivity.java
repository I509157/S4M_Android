 ...
 * - {@link NotesAdvisorSetCreateFragment}: to create or edit a(n) NotesAdvisor,
 * - {@link NotesAdvisorSetDetailFragment}: to display the details of a(n) NotesAdvisor,
 * - {@link NotesAdvisorSetListFragment}: to list NotesAdvisorSet.
 *
 ...
 * what to do.
 */
public class NotesAdvisorSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<NotesAdvisor> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link NotesAdvisorSetListFragment} is
     * getting instantiated (which will load {@link NotesAdvisorSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotesAdvisorSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable NotesAdvisor entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        NotesAdvisorSetCreateFragment fragment = new NotesAdvisorSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable NotesAdvisor entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotesAdvisorSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new NotesAdvisorSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable NotesAdvisor entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link NotesAdvisorSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((NotesAdvisorSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            NotesAdvisorViewModel viewModel = ViewModelProviders.of(getActivity()).get(NotesAdvisorViewModel.class);
