 ...
 * - {@link CustProdInstSetCreateFragment}: to create or edit a(n) CustProdInst,
 * - {@link CustProdInstSetDetailFragment}: to display the details of a(n) CustProdInst,
 * - {@link CustProdInstSetListFragment}: to list CustProdInstSet.
 *
 ...
 * what to do.
 */
public class CustProdInstSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CustProdInst> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CustProdInstSetListFragment} is
     * getting instantiated (which will load {@link CustProdInstSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CustProdInstSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CustProdInst entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CustProdInstSetCreateFragment fragment = new CustProdInstSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CustProdInst entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CustProdInstSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CustProdInstSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CustProdInst entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CustProdInstSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CustProdInstSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CustProdInstViewModel viewModel = ViewModelProviders.of(getActivity()).get(CustProdInstViewModel.class);
