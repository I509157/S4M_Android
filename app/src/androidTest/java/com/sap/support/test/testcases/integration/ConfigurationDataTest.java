package com.sap.support.test.testcases.integration;
...
public class ConfigurationDataTest {
    ...
    private static String GOOD_URL = "https://mobile-dgq5qdz5dm.int.sap.eu2.hana.ondemand.com/";
    ...
    private static String GOOD_DISC_SVC_DFLT =
            ...
            + "    \"port\": 443,\n"
            + "    \"protocol\": \"https\",\n"
            + "    \"appID\": \"com.sap.support.msggo.release\"\n"
            + "}\n";
