package com.sap.support.test.pages;
...
import com.sap.support.test.core.AbstractPasscodePage;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("com.sap.support:id/passcode_field")).setText(passcode);
